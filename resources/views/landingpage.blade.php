                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="{{asset('public/landingpage/assets/img/logo/logo.png')}}" alt="" style="height:50px;"><b class="text-white">BWIBUS</b></a>
                                </div>
                            </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-25">
                                    <a href="{{url('/')}}"><img style="width:50px;" src="{{asset('public/landingpage/assets/img/logo/logo.png')}}" alt=""> BWI BUS</a>
                                </div>
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Kami adalah perusahaan yang melayani berbagai informasi bus di wilayah banyuwangi. Mulai dari tarif rute dan jadwal pemberangkatan bus.</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 ">
                            <div class="footer-copy-right text-center">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="{{url('/')}}" target="_blank">BWIBUS</a>
